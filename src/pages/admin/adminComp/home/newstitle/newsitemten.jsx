...
class NewsItemTen extends Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount() {
        const wrapper= document.querySelector('.wrapper10')
    ...
    render() {
        let { newsList } = this.state;
        return (
                <div className="wrapper10  " style={{ width: 640, height: 202, borderRadius: 4, overflow: 'hidden' }}>
