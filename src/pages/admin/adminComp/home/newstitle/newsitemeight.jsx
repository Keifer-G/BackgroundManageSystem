...
class NewsItemEight extends Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount() {
        const wrapper= document.querySelector('.wrapper8')
    ...
    render() {
        let { newsList } = this.state;
        return (
                <div className="wrapper8  " style={{ width: 640, height: 202, borderRadius: 4, overflow: 'hidden' }}>
