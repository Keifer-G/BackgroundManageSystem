...
class NewsItemNine extends Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount() {
        const wrapper= document.querySelector('.wrapper9')
    ...
    render() {
        let { newsList } = this.state;
        return (
                <div className="wrapper9  " style={{ width: 640, height: 202, borderRadius: 4, overflow: 'hidden' }}>
